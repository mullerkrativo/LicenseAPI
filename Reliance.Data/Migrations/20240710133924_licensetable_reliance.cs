...
namespace Reliance.Data.Migrations
{
    public partial class licensetable_reliance : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LicenseKeyParameter = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Licensekey = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Licensetables", x => x.ID);
                });
